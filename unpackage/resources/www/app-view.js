...
Z([[7],[3,'hasLogin']])
Z([3,'_view 41c9774c hello'])
Z([3,'_view 41c9774c title'])
Z([a,[3,'您好 '],[[7],[3,'userName']],[3,'，您已成功登录。']])
Z([3,'_view 41c9774c ul'])
Z([3,'_view 41c9774c'])
...
(function(z){var a=11;function Z(ops){z.push(ops)}
Z([3,'02523f9a'])
Z([3,'_view 02523f9a content'])
Z([3,'_view 02523f9a btn-row'])
Z([[2,'!'],[[7],[3,'hasLogin']]])
Z([3,'handleProxy'])
Z([3,'_button 02523f9a primary'])
Z([[7],[3,'$k']])
Z([1,'02523f9a-0'])
Z([3,'primary'])
Z([3,'登录'])
